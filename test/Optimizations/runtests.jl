...
using ITensorNetworkAD.ITensorNetworks:
  PEPS, inner_network, inner_networks, Models, flatten, insert_projectors, split_network, MPSTensor
...
@testset "test MPSTensor" begin
  ...
  params = Dict(:stepsize=>0.005, :num_sweeps=>num_sweeps, :maxdim=>1000, :cutoff=>1e-15, :method=>"general_mps")
  losses_gd = gradient_descent(peps, H_line, abstract_network, MPSTensor; params...)
